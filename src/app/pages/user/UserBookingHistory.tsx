  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="container mx-auto px-4 py-8 max-w-6xl">
        ...
        <GlassCard className="p-4 mb-6 bg-gradient-to-r from-blue-50 to-yellow-50 border-l-4 border-[#808000]">
          <div className="flex items-start gap-3">
            <div className="w-10 h-10 bg-[#808000] rounded-full flex items-center justify-center flex-shrink-0">
